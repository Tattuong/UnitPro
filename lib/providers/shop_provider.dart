...
class ShopProvider extends ChangeNotifier {
  static const _coinsKey = 'unp_coins';
  static const _ownedKey = 'unp_owned_items';
  static const _activeThemeKey = 'unp_active_theme';
  static const _activeBgKey = 'unp_active_background';
  static const _activeSkinKey = 'unp_active_skin';
  static const _lastDailyKey = 'unp_last_daily_reward';
  static const _levelRewardDateKey = 'unp_note_reward_date';
  static const _levelRewardCountKey = 'unp_note_reward_count';
  static const _processedPurchasesKey = 'unp_processed_purchases';
  static const _lastSpinKey = 'unp_last_spin_date';
  static const _loginStreakKey = 'unp_login_streak';
  static const _lastStreakDateKey = 'unp_last_streak_date';
  static const _firstPurchaseBonusKey = 'unp_first_purchase_bonus_used';
  ...
  bool get hasProPack => _ownedItems.contains('feat_paper_pack');
  bool get hasPrecision => _ownedItems.contains('feat_open_spaces');
  bool get hasPaperPack => hasProPack;
  bool get hasOpenSpaces => hasPrecision;
  ...
  Future<bool> rewardForLevelComplete(int baseAmount) async {
    ...
    return _dailyReward(
      ...
      max: IapConstants.maxConvertRewardsPerDay,
      amount: amount,
      messageKey: 'levelRewardEarned',
    );
  }

  Future<bool> rewardForConversion() {
    return rewardForLevelComplete(IapConstants.convertReward);
  }

  Future<bool> rewardForNoteSave() => rewardForConversion();
